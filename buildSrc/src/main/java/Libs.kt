...
object Libs {
    ...
    const val COMPOSE_TOOLING_PREVIEW = "androidx.compose.ui:ui-tooling-preview:1.1.1"
    const val COMPOSE_NAVIGATION = "androidx.navigation:navigation-compose:2.4.2"
